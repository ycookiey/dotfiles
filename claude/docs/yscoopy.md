...
```powershell
& "C:/Main/Project/dotfiles/bin/yscoopy-add.ps1" <AppName> <RepoName> "説明文"
# 例: & "C:/Main/Project/dotfiles/bin/yscoopy-add.ps1" yclocky yClocky "A minimal clock app for Windows"
```
